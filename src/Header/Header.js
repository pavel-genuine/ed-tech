    ...
    const personalizeItems =
        <> {
            ...
            <div class="dropdown dropdown-end">
                <label tabindex="0" htmlFor='toggler2' class="btn mr-1 md:mr-4 btn-ghost btn-circle">
                    <div class="indicator">
                ...
                <div class="lg:navbar lg:w-[82%] mx-auto ">
                    ...
                    <div class="navbar-end ml-4 flex hidden lg:block">
...

                        {
                            user &&
                            <div class="dropdown dropdown-end">
                                <label tabindex="0" htmlFor='bigToggler2' class="btn mr-1 md:mr-4 btn-ghost btn-circle">
                                    <div class="indicator">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
                                        <span class="badge bg-[brown] border-none text-[white] badge-sm indicator-item">3</span>
                                    </div>
...

                        {
                            ...
                            user && <div class="dropdown dropdown-end ">
                                ...
                                <label tabindex="0" htmlFor="bigToggler" name="toggle" class="btn btn-ghost btn-circle avatar">
                                    <div class="w-9 border border-[brown] rounded-full" >
                                        <img
                                            src="https://i.stack.imgur.com/frlIf.png" />
                                    </div>
